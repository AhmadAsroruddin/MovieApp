...
void main() {
  ...
  final tSeries = Series(
      ...
      name: "Victoria",
      originalName: "Victoria");
  final testMovieCache = SeriesTable(
    id: 557,
    overview:
  ...
  final tMovieModelList = <SeriesModel>[tSeriesModel];
  final tMovieList = <Series>[tSeries];
  ...
  group('Now Playing Movies', () {
    ...
    group('when device is offline', () {
      ...
      test('should return cache data when device offline', () async {
        //arrange
        when(mockLocalDataSource.getCachedNowPlayingSeriess())
        ...
        //assert
        verify(mockLocalDataSource.getCachedNowPlayingSeriess());
        final resultList = result.getOrElse(() => []);
  ...
  group('Get Movie Detail', () {
    ...
    final tSeriesResponse = SeriesDetailResponse(
        ...
        first_air_date: DateTime.parse("2011-04-17"),
        genres: [GenreModel(id: 10765, name: "Sci-Fi & Fantasy")],
        homepage: "http://www.hbo.com/game-of-thrones",
        id: 1399,
        in_production: false,
        languages: ["en"],
        last_air_date: DateTime.parse("2019-05-19"),
  ...
  group('get watchlist movies', () {
    test('should return list of Movies', () async {
      // arrange
      when(mockLocalDataSource.getWatchlistSeriess())
